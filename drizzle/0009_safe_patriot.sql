CREATE TABLE "live_queues" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"owner_user_id" text NOT NULL,
	"name" varchar(120) NOT NULL,
	"live_queue_type" varchar(50) DEFAULT 'music' NOT NULL,
...
ALTER TABLE "user" ADD COLUMN "active_live_queue_id" uuid;--> statement-breakpoint
ALTER TABLE "live_queues" ADD CONSTRAINT "live_queues_owner_user_id_user_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "submissions" ADD CONSTRAINT "submissions_live_queue_id_live_queues_id_fk" FOREIGN KEY ("live_queue_id") REFERENCES "public"."live_queues"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "live_queues_owner_name_unique" ON "live_queues" USING btree ("owner_user_id","name");--> statement-breakpoint

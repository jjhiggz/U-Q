...
import { C__SpinWheel } from "./C__SpinWheel";
...
interface I_Props_C__SpinWheelModal {
	open: boolean;
...
export function C__SpinWheelModal({
	open,
	onOpenChange,
	songs,
	onArchiveSong,
}: I_Props_C__SpinWheelModal) {
	...
	return (
		<Dialog open={open} onOpenChange={handleClose}>
			<DialogContent className="sm:max-w-lg">
				...
				<div className="py-4">
					{match({ showResult, winner })
						.with({ showResult: true, winner: P.nonNullable }, ({ winner }) => (
							// Winner display

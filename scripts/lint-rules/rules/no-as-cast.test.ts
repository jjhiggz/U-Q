...
describe("no-as-cast", () => {
	...
	it("flags 'as HTMLInputElement'", () => {
		expect(lint(`const el = e.target as HTMLInputElement;`)).toHaveLength(1);
	});

	it("flags 'as HTMLFormElement'", () => {
		expect(lint(`const form = e.target as HTMLFormElement;`)).toHaveLength(1);
	});
